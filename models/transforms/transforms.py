...
class GeneralizedRCNNTransform(nn.Module):
    ...
    def post_process(self, result, image_shapes, original_image_sizes):
...
def resize_boxes(boxes, original_size, new_size):
    ...
    ratios = [
        ...
        torch.tensor(s_org, dtype=torch.float32, device=boxes.device)
