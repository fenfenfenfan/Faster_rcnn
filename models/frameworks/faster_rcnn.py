...
from typing import OrderedDict, Tuple, List, Dict, Optional, Union
from collections import OrderedDict

from .roi_head import ROIHeads
from .transform import GenerlizedRCNNTransform
from .rpn_function import AnchorGenerator, RPNHead, RegionProposalNetwork
...
class FasterRCNNBase(nn.Module):
    ...
    def forward(self, images, targets=None):
        ...
        detections, detector_losses = self.roi_head(features, proposals,
                                                    images.image_sizes,
...
class FasterRCNN(FasterRCNNBase):
    ...
    def __init__(
        ...
        if box_predictor is None:
            representation_size = 1024
            box_predictor = FasterRCNNPredictor(representation_size,
                                                num_classes)
        ...
        transform = GenerlizedRCNNTransform(min_size, max_size, image_mean,
                                            image_std)
